...
const WaveDivider = () => {
    ...
    return (
        <div className="w-full flex items-end justify-center m-0 p-0">
            <motion.svg variants={variants} animate="default" className="w-full" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
