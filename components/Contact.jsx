...
const Contact = () => {
  return (
    <div className="bg-black w-full h-[700px] flex flex-Col min-h-screen justify-between">
      <div className="w-1/2 flex justify-evenly items-center ">
        ...
        <div className="h-full w-[130px] flex justify-center items-center overflow-hidden">
          <a
            ...
            className="rotate-270 whitespace-nowrap font-anton text-10xl link hover:no-underline"
          >
            Instagram
          </a>
        </div>
      ...
      <div className="whitespace-nowrap font-abril text-10xl  w-1/2 flex flex-col justify-center items-center overflow-hidden">
        <div className="h-[105px]">
          <div className="font-anton text-12xl white-stroke">CONTACT</div>
        </div>
